...
int main() {
    ...
    const int bitLength = 2, Lambda = 2, L = 4, radiusBitLength = 1;
    ...
    auto intersection = GRS22_L_infinity_protocol::SetIntersectionServer<bitLength, Lambda, L, radiusBitLength>(centers, "localhost", 1);
